...
buildVariants() {
    ...
    # Okay, so here's the thing, this is the easiest way to select the build
    # variant. You can select the variant you want to build by uncommenting
    # ignore this note if you know the bettter way
